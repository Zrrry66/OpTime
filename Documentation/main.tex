...
\subsubsection{The Multi-Dimensional Availability Matrix}
\todo[inline]{2.28}
To address the inherent complexity of faculty time preferences, we developed an \textbf{Interactive Availability Matrix} (see Figure \ref{fig:matrix_l}). This component acts as the primary interface for translating human availability into the mathematical constraints used by the solvers.
These categories (Red/Yellow) correspond directly to the hard and soft constraint weights in the optimization engine.
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.8\textwidth}
        ...
        \caption{Available time slots from the lecturer's perspective.}
        \label{fig:matrix_l}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.8\textwidth}
        ...
        \caption{Available time slots for a specific course.}
        \label{fig:matrix_c}
    \end{subfigure}
\end{figure}
