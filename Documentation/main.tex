...
The OpTime application follows a Dashboard-Centric layout designed for maximum administrative efficiency. The visual architecture is structured to ensure that critical navigation and data operations are always within one click of the user's focus (see Figure \ref{fig:dashboard}).
\begin{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Documentation/img/ui_main_dashboard.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Documentation/img/ui_availability_matrix.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Documentation/img/ui_add_course_modal.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Documentation/img/ui_generated_timetable.png}
